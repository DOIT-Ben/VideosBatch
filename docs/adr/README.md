...
| [0004](0004-durable-production-scheduler.md) | 持久化多任务调度与自动流水线 | Accepted | [P0—P2](automation-workspace-plan.md)，P0 执行中，详见台账 |
| [0005](0005-realtime-rendering-feedback.md) | 实时状态、渐进渲染与反馈 | Accepted | [P3/P6](automation-workspace-plan.md)，P0 执行中，详见台账 |
| [0006](0006-multitask-editing-workbench.md) | 多任务管理与编辑保存推进 | Accepted | [P4—P6](automation-workspace-plan.md)，P0 执行中，详见台账 |
