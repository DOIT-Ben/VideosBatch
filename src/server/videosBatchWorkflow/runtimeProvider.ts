...
export function resolveVideosBatchRuntimeConfig(
  ...
  const llm = resolveVideosBatchLlmConfig({
    ...
    VIDEOSBATCH_LLM_REASONING: trimmed(env, "VIDEOSBATCH_LLM_REASONING"),
    ...
    VIDEOSBATCH_LLM_FALLBACK_2_MODEL: trimmed(env, "VIDEOSBATCH_LLM_FALLBACK_2_MODEL"),
    VIDEOSBATCH_LLM_FALLBACK_2_BASE_URL: trimmed(env, "VIDEOSBATCH_LLM_FALLBACK_2_BASE_URL"),
    VIDEOSBATCH_LLM_FALLBACK_2_API_KEY: trimmed(env, "VIDEOSBATCH_LLM_FALLBACK_2_API_KEY"),
    VIDEOSBATCH_LLM_FALLBACK_2_REASONING: trimmed(env, "VIDEOSBATCH_LLM_FALLBACK_2_REASONING")
  });
